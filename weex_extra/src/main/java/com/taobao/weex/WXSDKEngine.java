...
import com.taobao.weex.ui.component.input.WXRadioComponent;
import com.taobao.weex.ui.component.input.WXSelectComponent;
...
public class WXSDKEngine implements Serializable {
  ...
  private static void register() {
    ...
    try {
      ...
      registerComponent(WXBasicComponentType.RADIO, WXRadioComponent.class,false);
      registerComponent(WXBasicComponentType.SELECT, WXSelectComponent.class,false);
