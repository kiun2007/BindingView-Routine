package com.taobao.weex.ui.view.spinner;
...
public class WXSpinner extends Spinner{
    ...
    private WXSpinner.DropdownPopup mPopup;
    ...
    private View dropdownReference = null;
     ...
     */
    public WXSpinner(Context context) {
        this(context, null);
    }
     ...
     * @see #MODE_DROPDOWN
     */
    public WXSpinner(Context context, int mode) {
     ...
     */
    public WXSpinner(Context context, AttributeSet attrs) {
     ...
     */
    public WXSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @see #MODE_DROPDOWN
     */
    public WXSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode) {
     ...
     *                     specified by
     *                     {@link android.support.v7.appcompat.R.styleable#Spinner_popupTheme}.
     * @see #MODE_DIALOG
     * @see #MODE_DROPDOWN
     */
    ...
    public WXSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode,
        ...
        if (mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                final WXSpinner.DropdownPopup popup = new WXSpinner.DropdownPopup(mPopupContext, attrs, defStyleAttr);
    ...
    public void setDropDownReference(View view){
        dropdownReference = view;
    }
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        ...
        if (mPopup != null) {
            ...
            mPopup.setAdapter(new WXSpinner.DropDownAdapter(adapter, popupContext.getTheme()));
        }
    }
    ...
    int compatMeasureContentWidth(SpinnerAdapter adapter, Drawable background) {
        ...
        if (dropdownReference != null){
            return dropdownReference.getMeasuredWidth();
        }
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                    WXSpinner.this.setSelection(position);
        ...
        void computeContentWidth() {
            ...
            if (background != null) {
                background.getPadding(mTempRect);
                hOffset = ViewUtils.isLayoutRtl(WXSpinner.this) ? mTempRect.right
                        : -mTempRect.left;
            } else {
                mTempRect.left = mTempRect.right = 0;
            }

            final int spinnerPaddingLeft = WXSpinner.this.getPaddingLeft();
            final int spinnerPaddingRight = WXSpinner.this.getPaddingRight();
            final int spinnerWidth = WXSpinner.this.getWidth();
            ...
            if (ViewUtils.isLayoutRtl(WXSpinner.this)) {
        ...
        public void show() {
            ...
            setSelection(WXSpinner.this.getSelectedItemPosition());
            ...
            if (vto != null) {
                final ViewTreeObserver.OnGlobalLayoutListener layoutListener
                    ...
                    public void onGlobalLayout() {
                        if (!isVisibleToUser(WXSpinner.this)) {
                            dismiss();
                        } else {
                            computeContentWidth();
                            ...
                            WXSpinner.DropdownPopup.super.show();
                        }
                    }
                };
