...
//        jsonWriter.close();
//
//        Map<String,Object> map = new Gson().fromJson(new Gson().toJson(value), new TypeToken<HashMap<String,Object>>(){}.getType());
//
//
//        return RequestBody.create(MEDIA_TYPE, map.toString());
